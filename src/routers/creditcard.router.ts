...
creditRouter.put("/:creditId", authenticateToken, validateSchemaMiddleware(creditSchema),creditcontroller.updateCreditCard)
creditRouter.delete("/:creditId", authenticateToken, validateSchemaMiddleware(passwordbodySchema), creditcontroller.deleteCreditCard)
